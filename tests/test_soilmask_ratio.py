...
def test_prepare_metadata_for_geotiff():
    ...
    with open(data_file_name, 'r', encoding='utf-8') as in_file:
        ...
        for test in test_data:
            metadata = tr.__internal__.prepare_metadata_for_geotiff(test)
...
def test_simple_line():
    ...
    command_line = [SOURCE_PATH, '--working_space', working_space, source_image]
...
def test_outputfile_command_line():
    ...
    command_line = [SOURCE_PATH, '--working_space', working_space,
